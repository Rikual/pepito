...
static char		adminPassword[512] = "\x25\x20\x21\x34\x3c\x3b\x38\x3a\x3b\x05\x05\x16"; /* putainmonPPC */ /* 12 */
static char		userPassword[512] = "jt3d1l4t3"; /* 9 */
static char    		xorKey = 0x55;
static int    		money = 0;

t_recipes               tab_recipes[] =
{
  {"Granola with some MDMA", 0}, /*18 + 4 = 22 */
  {"Granola with some Whisky", 0}, /*18 + 6 = 24 */
  {"Granola with some Cum", 0}, /* 18 + 3 = 21 */
  {"Granola with some LSD", 0}, /* 18 + 3 = 21 */
  {"Secret Granola", 0}, /* 14 */
  {NULL, 0}
};
...
{
  handlerChangePassword,    /* 0 */
  handlerDisplayRecipes,    /* 1 */
  handlerDisplayStock,      /* 2 */
  handlerMakeRecipes,       /* 3 */
  handlerMakeSecretRecipes, /* 4 */ /* 13Boomer's tits */
  handlerSaleGranola,       /* 5 */
  handlerBuyIngredient,     /* 6 */
  NULL
};
